...
app = FastAPI(
    ...
    description="Learning and development agent that recommends personalized training paths, tracks skill development, manages course enrollments, measures learning effectiveness, and identifies organizational skill gaps.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
