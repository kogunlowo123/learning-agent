...
class LearningAgentAgent:
    ...
    def __init__(self):
        ...
        self.path_recommendation_enabled = True
        self.skill_tracking_enabled = True
        self.course_management_enabled = True
        self.effectiveness_measurement_enabled = True
        self.gap_identification_enabled = True
        self._tool_dispatch = {
            "recommend_learning_path": self.tools.recommend_learning_path,
            "enroll_course": self.tools.enroll_course,
            "track_progress": self.tools.track_progress,
            "measure_effectiveness": self.tools.measure_effectiveness,
            "identify_skill_gaps": self.tools.identify_skill_gaps,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['path_recommendation', 'skill_tracking', 'course_management', 'effectiveness_measurement', 'gap_identification'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "measure_effectiveness": ['measure', 'effectiveness'],
